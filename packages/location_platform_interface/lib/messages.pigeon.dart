...
class _LocationFlutterApiCodec extends StandardMessageCodec {
  const _LocationFlutterApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is LocationData) {
      buffer.putUint8(128);
...
abstract class LocationFlutterApi {
  static const MessageCodec<Object?> codec = _LocationFlutterApiCodec();

  void listenLocation(LocationData location);
  static void setup(LocationFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.LocationFlutterApi.listenLocation', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.LocationFlutterApi.listenLocation was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final LocationData? arg_location = (args[0] as LocationData?);
          assert(arg_location != null, 'Argument for dev.flutter.pigeon.LocationFlutterApi.listenLocation was null, expected non-null LocationData.');
          api.listenLocation(arg_location!);
          return;
        });
      }
    }
